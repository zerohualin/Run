...
namespace ET
{
    ...
    public class B2S_DebuggerComponentAwakeSystem : AwakeSystem<B2S_DebuggerComponent>
    {
        public override void Awake(B2S_DebuggerComponent self)
        {
            ...
            gameObject.transform.SetParent(self.GetParent<Unit>().GetComponent<GameObjectComponent>().GameObject.transform);
    ...
    [ObjectSystem]
    public class B2S_DebuggerComponentFixedUpdate : LateUpdateSystem<B2S_DebuggerComponent>
    {
        public override void LateUpdate(B2S_DebuggerComponent self)
        {
    ...
    [FriendClass(typeof(B2S_DebuggerComponent))]
            ...
            else
            {
                ...
                switch (b2SColliderComponent.B2S_ColliderDataStructureBase)
                {
                    ...
                    case B2S_CircleColliderDataStructure b2SCircleColliderDataStructure:
                        ...
                        {
                            finalVexs[i / step] = transformMatrix4X4.MultiplyPoint(new Vector3(b2SCircleColliderDataStructure.radius *
                    ...
                    case B2S_PolygonColliderDataStructure b2SPolygonColliderDataStructure:
                        ...
                        for (int i = 0; i < b2SPolygonColliderDataStructure.finalPoints.Count; i++)
                        {
                            ...
                            {
                                finalVexs[index] = transformMatrix4X4.MultiplyPoint(new Vector3(b2SPolygonColliderDataStructure.finalPoints[i][j].X +
                            ...
                            {
                                finalVexs[index] = transformMatrix4X4.MultiplyPoint(new Vector3(b2SPolygonColliderDataStructure.finalPoints[0][0].X +
                                    b2SPolygonColliderDataStructure.finalOffset.X, 1,
