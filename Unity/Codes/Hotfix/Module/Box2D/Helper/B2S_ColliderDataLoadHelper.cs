...
namespace ET
{
    ...
    public static class B2S_ColliderDataLoadHelper
    {
        ...
        public static void CreateB2S_Collider(this B2S_ColliderComponent self)
        {
            ...
            self.B2S_ColliderDataStructureBase =
                    b2SColliderDataRepositoryComponent.GetDataByColliderId(B2SColliderConfigCategory.Instance.Get(self.B2S_ColliderDataConfigId)
                            .B2S_ColliderId);
        ...
        Quaternion worldRotation, long sustainTime)
        {
            ...
            B2S_ColliderDataStructureBase b2SColliderDataStructureBase =
                    b2SColliderDataRepositoryComponent.GetDataByColliderId(B2SColliderConfigCategory.Instance.Get(b2S_ColliderDataConfigId)
                            .B2S_ColliderId);
