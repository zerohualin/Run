...
namespace ET
{
    ...
    public class Darius_Q_CollisionHandler : AB2S_CollisionHandler
    {
        public override void HandleCollisionStart(Unit a, Unit b)
        {
            ...
            B2S_RoleCastComponent aRole = aColliderComponent.BelongToUnit.GetComponent<B2S_RoleCastComponent>();
            
            B2S_ColliderComponent bColliderComponent = b.GetComponent<B2S_ColliderComponent>();
            B2S_RoleCastComponent bRole = bColliderComponent.BelongToUnit.GetComponent<B2S_RoleCastComponent>();
