...
namespace ET
{
    ...
    public class B2S_ColliderEditor : OdinEditorWindow
    {
        ...
        private void ReadcolliderData()
        {
            ...
            BsonClassMap.LookupClassMap(typeof(System.Numerics.Vector2));
            ...
            if (File.Exists($"{B2S_BattleColliderExportPathDefine.ServerColliderDataSavePath}/{this.colliderDataName[2]}.bytes"))
            {
                byte[] mfile2 =
                    File.ReadAllBytes(
                ...
                if (mfile2.Length > 0)
                {
                    this.PolygonColliderDataSupporter = BsonSerializer.Deserialize<ColliderDataSupporter>(mfile2);
                }
            }
        }
