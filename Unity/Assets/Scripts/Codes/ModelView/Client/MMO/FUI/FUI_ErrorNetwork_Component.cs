...
namespace ET.Client
{
    [FGUIComponent(Cfg.FGUIType.ErrorNetwork)]
    [FriendOf(typeof(IFGUIComponent))]
    public sealed partial class FUI_ErrorNetwork_Component : Entity, IAwake
    {
        ...
        [FGUIObject]
        public GTextField hintUp;
        [FGUIObject]
        public GTextField hintDown;
    }
}