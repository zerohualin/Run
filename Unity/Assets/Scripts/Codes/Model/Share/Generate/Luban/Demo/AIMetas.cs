...
public sealed partial class AIMetas :  Bright.Config.BeanBase 
{
    ...
    {
        Id = _buf.ReadInt();
        {int n0 = System.Math.Min(_buf.ReadSize(), _buf.Size);Metas = new System.Collections.Generic.List<Demo.AIMeta>(n0);for(var i0 = 0 ; i0 < n0 ; i0++) { Demo.AIMeta _e0;  _e0 = Demo.AIMeta.DeserializeAIMeta(_buf); Metas.Add(_e0);}}
        PostInit();
    }
