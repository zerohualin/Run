...
namespace ET.Client
{
    ...
    public static partial class LoginHelper
    {
        ...
        //     try
        //     {
        //         a2CGetRealmKey = (A2C_GetRealmKey)await zoneScene.SeesionCall(new C2A_GetRealmKey(){
        //             Token = zoneScene.GetToken(),
        //             AccountId = zoneScene.GetAccountId(),
        //             ServerId = zoneScene.GetServerId()
        //         });
        //     }
        //     catch (Exception e)
        //     {
        ...
        //     //拿到了realm分配的地址和key 结束与账号服务器的连接了
        ...
        //
        //     Session realmSession = zoneScene.GetComponent<NetKcpComponent>()
        ...
        //         .Create(NetworkHelper.ToIPEndPoint(r2CLoginRealm.GateAddress));
        //     gateSession.AddComponent<PingComponent>();
        //     zoneScene.GetComponent<SessionComponent>().Session = gateSession;
        //
        //     long currentRoleId = zoneScene.GetComponent<RoleInfosComponent>().CurrentRoleId;
        ...
        //     try
        //     {
        //         long accountId = zoneScene.GetAccountId();
        ...
        //     }
        //
        //     zoneScene.GetComponent<PlayerComponent>().MyId = g2CEnterGame.MyUnitId;
        //
        //     Log.Debug("角色进入游戏成功！！！");
        //     
