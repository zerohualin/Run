...
namespace ET
{
    public static class BuildAssembliesHelper2
    {
        public const string CodeDir = "Assets/BundleYoo/Code/";
        ...
        public static void BuildModel(CodeOptimization codeOptimization, GlobalConfig globalConfig)
        {
            ...
            File.Copy(Path.Combine(Define.BuildOutputDir, $"Model.dll"), Path.Combine($"HybridCLRData/HotUpdateDlls/{EditorUserBuildSettings.activeBuildTarget}/", $"Model.dll"), true);
        ...
        public static void BuildHotfix(CodeOptimization codeOptimization, GlobalConfig globalConfig)
        {
            ...
            File.Copy(Path.Combine(Define.BuildOutputDir, $"{logicFile}.dll"), Path.Combine($"HybridCLRData/HotUpdateDlls/{EditorUserBuildSettings.activeBuildTarget}/", $"Hotfix.dll"), true);
