...
namespace YooAssetEx
{
    public static class PatchUpdater
    {
        ...
        /// 资源版本
        /// </summary>
        public static string ResourceVersion { set; get; }
        ...
        private static void OnHandleEvent(IEventMessage msg)
        {
            ...
            else if (msg is PatchEventMessageDefine.StaticVersionUpdateFailed)
            {
                ...
                Log.Info($"Failed to update static version, please check the network status.");
            }
            else if (msg is PatchEventMessageDefine.PatchManifestUpdateFailed)
            {
                ...
                Log.Info($"Failed to update patch manifest, please check the network status.");
            }
            else if (msg is PatchEventMessageDefine.WebFileDownloadFailed)
            {
                ...
                Log.Info($"Failed to download file : {message.FileName}");
            }
            else
            {
